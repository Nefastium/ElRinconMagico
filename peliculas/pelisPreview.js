        ...
        layouts.innerHTML+=`
            <div>
                <h1 class="tituloLibro">${datos.titulo}</h1>
                    ...
                    <iframe width="500" height="300" src="${datos.trailer}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            </div>
            <div>
                <h1 class="tituloLibro">${datos.sinop}</h1>
                    ...
                    <div class="menu">
                        <div class="acordeon">
                            <input type="radio" id="btn1" class="boton">
                            <label for="btn1">
                                Fecha
                            </label>
                            <div class="contenido">
                        ...
                        <div class="acordeon">
                            <input type="radio" id="btn2" class="boton">
                            <label for="btn2">
                                Director
                            </label>
                            <div class="contenido">
                        ...
                        <div class="acordeon">
                            <input type="radio" id="btn3" class="boton">
                            <label for="btn3">
                                Guionista
                            </label>
                            <div class="contenido">
                        ...
                        <div class="acordeon">
                            <input type="radio" id="btn4" class="boton">
                            <label for="btn4">
                                Productor
                            </label>
                            <div class="contenido">
